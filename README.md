...
## Docvec model
Docvecs are learned from the tweet text and used as a feature in a classifier. This approach does not outperform the bag of words model (public score: 0.75). Perhaps there is not enough data to the docvecs.
